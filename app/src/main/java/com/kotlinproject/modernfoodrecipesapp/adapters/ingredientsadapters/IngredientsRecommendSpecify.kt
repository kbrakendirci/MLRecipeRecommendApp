...
import com.elfay.myfridgerecipies.models.recipe_details.ExtendedIngredient
...
class IngredientsRecommendSpecify : RecyclerView.Adapter<IngredientsRecommendSpecify.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        holder.itemView.ingredient_imageView.load(Constant.BASE_IMAGE_URL + ingredientsList[position].image) {
            crossfade(600)
    ...
    fun setData(newIngredientList: List<com.elfay.myfridgerecipies.models.recipe_details.ExtendedIngredient>) {
